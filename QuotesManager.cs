...
namespace Kalendarz1
{
    ...
    public static class QuotesManager
    {
        ...
        private static readonly List<Quote> DefaultQuotes = new List<Quote>
        {
            ...
            new Quote { Text = "Nie czekaj na idealny moment. Weź moment i uczyń go idealnym.", Author = "Zoey Sayward" },
            ...
            new Quote { Text = "Każdy dzień to nowa szansa, by zmienić swoje życie.", Author = "Nieznany" },
            new Quote { Text = "Wielkie rzeczy nigdy nie przychodzą ze strefy komfortu.", Author = "Nieznany" },
            ...
            new Quote { Text = "Najlepszy czas na posadzenie drzewa był 20 lat temu. Drugi najlepszy czas jest teraz.", Author = "Chińskie przysłowie" },
            ...
            new Quote { Text = "Praca zespołowa sprawia, że marzenia się spełniają.", Author = "Nieznany" },
        ...
        /// Dodaje nowy cytat
        /// </summary>
        public static bool AddQuote(string text, string author)
        {
            try
            {
        ...
        /// Format: [{"Text": "cytat", "Author": "autor"}, ...]
        /// </summary>
        public static (bool success, int count, string error) ImportFromFile(string filePath)
        {
            try
            {
                ...
                var importedQuotes = JsonSerializer.Deserialize<List<Quote>>(json);
                ...
                var validQuotes = importedQuotes
                    ...
                    {
                        Text = q.Text.Trim(),
                        Author = string.IsNullOrWhiteSpace(q.Author) ? "Nieznany" : q.Author.Trim()
                    })
                    .ToList();
