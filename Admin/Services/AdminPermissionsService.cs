    ...
    public class AdminPermissionsService
    {
        ...
        public List<AdminModuleInfo> GetModulesList()
        {
            return new List<AdminModuleInfo>
            {
                ...
                new() { Key = "UstalanieTranportu",   DisplayName = "Planowanie Transportu", Description = "Lista kursów + edytor z ETA (auto-uczy się z historii GPS)", Category = "Opakowania i Transport", Icon = "🚚" },
